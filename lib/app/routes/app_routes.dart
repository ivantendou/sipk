...
abstract class Routes {
  ...
  static const AO_HOME = _Paths.AO_HOME;
  static const BOTTOM_NAV_AO = _Paths.BOTTOM_NAV_AO;
  static const AO_SUBMISSION = _Paths.AO_SUBMISSION;
  ...
  static const ADMIN_MANAGE_DATA = _Paths.ADMIN_MANAGE_DATA;
  static const ADMIN_MANAGE_USER = _Paths.ADMIN_MANAGE_USER;
  static const BOTTOM_NAV_ADMIN = _Paths.BOTTOM_NAV_ADMIN;
  static const BOTTOM_NAV_MANAGER = _Paths.BOTTOM_NAV_MANAGER;
...
abstract class _Paths {
  ...
  static const AO_HOME = '/ao-home';
  static const BOTTOM_NAV_AO = '/bottom-nav-ao';
  static const AO_SUBMISSION = '/ao-submission';
  ...
  static const ADMIN_MANAGE_DATA = '/admin-manage-data';
  static const ADMIN_MANAGE_USER = '/admin-manage-user';
  static const BOTTOM_NAV_ADMIN = '/bottom-nav-admin';
  static const BOTTOM_NAV_MANAGER = '/bottom-nav-manager';
