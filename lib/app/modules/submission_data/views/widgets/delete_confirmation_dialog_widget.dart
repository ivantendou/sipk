...
void showDeleteConfirmationDialog(SubmissionDataController controller) {
  Get.defaultDialog(
    ...
    content: Text(
      'Apakah Anda yakin ingin menghapus ${controller.selectedCount} data pengajuan? Tindakan ini tidak dapat dibatalkan.',
